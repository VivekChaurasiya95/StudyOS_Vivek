  ...
  return (
    <div className="flex bg-background min-h-screen text-text-main font-sans overflow-hidden">
      ...
      <div className="flex-1 flex flex-col md:ml-20 xl:mr-[340px] min-h-screen relative transition-all duration-300 z-0">
          ...
          <div className="flex bg-surface p-2 rounded-full shadow-card border border-border/50 items-center gap-2 overflow-x-auto max-w-[90vw] custom-scrollbar">
            ...
            <div className="flex bg-background rounded-full p-1 border border-border/50 shadow-inner">
              <button
                ...
                className={`p-2.5 rounded-full transition-all flex items-center justify-center gap-1`}
                style={{
                  backgroundColor:
            ...
            <div className="flex gap-2 px-2 items-center">
              {colors.map((c) => (
                <button
                  ...
                  className={`w-6 h-6 rounded-full transition-all relative ${color === c && tool !== "eraser" ? "scale-110 z-10" : "hover:scale-110"}`}
              ...
              <div className="relative">
                ...
                />
                <div
                  className="w-6 h-6 rounded-full border-2 border-dashed border-text-muted/40 hover:border-primary/60 transition-all flex items-center justify-center cursor-pointer"
                  style={{
              ...
              {linePicks.map((s) => (
                <button
                  ...
                  style={{
                    ...
                    backgroundColor:
                      lineWidth === s && tool !== "eraser"
                        ? color
                        : "var(--color-text-muted)",
                    opacity: lineWidth === s ? 1 : 0.4,
                  }}
                  title={`Size ${s}px`}
                />
              ))}
            ...
            <div className="flex items-center gap-1 pl-1">
              <button
                onClick={clearCanvas}
                className="p-2 rounded-full text-text-muted hover:text-text-main transition-colors"
                title="Clear Canvas"
              >
                <Sparkles size={18} />
              </button>
              <button
                ...
                className="p-2 rounded-full text-text-muted hover:text-text-main transition-colors disabled:opacity-40"
                title="Save Sketch"
              >
                {saving ? (
              ...
              <button
                ...
                disabled={!hasDrawn}
                className="flex items-center gap-2 bg-background px-4 py-2 rounded-full border border-border/50 text-sm font-semibold text-text-main hover:text-primary transition-all shadow-sm ml-2 disabled:opacity-40"
                title="Export Image"
              >
                <Download size={16} />
        ...
        {/* ── Canvas Workspace ── */}
        <main className="flex-1 relative isolate bg-surface m-4 md:m-6 rounded-[2.5rem] shadow-sm border border-border/40 overflow-hidden group">
          {/* Dot grid */}
          <div
          ...
          <div className="absolute bottom-6 left-6 z-30 flex flex-col gap-3">
            <button
              onClick={handleUndo}
              className="p-3 bg-surface rounded-2xl shadow-card border border-border/50 text-text-secondary hover:text-primary transition-colors"
              title="Undo"
            >
              <Undo2 size={20} />
            </button>
            ...
            <button
              ...
              className="p-3 bg-surface rounded-2xl shadow-card border border-border/50 text-text-secondary hover:text-primary transition-colors mt-2"
              title="Zoom In"
            >
              <ZoomIn size={20} />
            </button>
