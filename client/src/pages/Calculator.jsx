...
const Calculator = () => {
  ...
  const sciColor =
    "hidden md:flex bg-background text-text-secondary font-semibold hover:bg-border/50";
  const numColor =
    "bg-background text-text-main font-bold text-xl hover:bg-border/50";
  const opColor =
    "bg-background text-primary font-semibold text-xl hover:bg-primary/10";
  ...
  const buttons = scientificMode
    ? [
        ...
        { label: "6", color: numColor },
        {
          ...
          value: "-",
          color:
            "bg-background text-primary font-semibold text-3xl pb-1 hover:bg-primary/10",
        },
        ...
        { label: "3", color: numColor },
        {
          label: "+",
          color:
            "bg-background text-primary font-semibold text-2xl hover:bg-primary/10",
        },
        ...
        { label: ".", color: numColor },
        {
          label: "=",
          color:
            "bg-primary text-white font-bold text-2xl hover:bg-primary/90 shadow-[0_8px_16px_rgba(16,185,129,0.3)]",
          classes: "col-span-2",
        },
      ]
    : [
