          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 mb-10">
            ...
            <div className="flex flex-col gap-4">
              ...
              <div className="flex gap-3 mt-1">
                <a href="https://github.com/arin-gupta06/StudyOS_Vivek-Arin_Version" target="_blank" rel="noopener noreferrer"
                  className="w-8 h-8 rounded-full bg-border flex items-center justify-center text-text-secondary hover:text-text-main hover:bg-accent/20 transition-colors">
