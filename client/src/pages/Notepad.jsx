      ...
      <div className="flex-1 md:ml-20 xl:mr-80 main-content right-panel-transition flex h-screen overflow-hidden">
        ...
        <main className="flex-1 flex flex-col bg-surface overflow-hidden">
          ...
          <header className="h-14 border-b border-border flex items-center justify-between px-4 md:px-6 bg-surface/80 backdrop-blur-md sticky top-0 z-10 shrink-0">
            ...
            <div className="flex items-center gap-2">
              ...
              <button
                onClick={handleShare}
                className="btn-primary flex items-center gap-2 !px-4 !py-2 text-sm hidden sm:flex"
              >
        ...
        <aside className="hidden lg:flex w-80 border-l border-border bg-background/50 flex-col shrink-0 overflow-y-auto p-5 gap-5">
          ...
          {notebook && (
            <button
              onClick={deleteNb}
              className="flex items-center justify-center gap-2 py-2.5 text-xs text-rose-400 hover:bg-rose-500/10 rounded-xl border border-dashed border-rose-400/30 transition-all"
            >
